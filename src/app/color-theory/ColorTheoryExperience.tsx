...
const principles = [
  ...
  { title: 'Analogous', Icon: Waves, angle: '±30°', pair: ['#3B82F6', '#8B5CF6', '#EC4899'],
    desc: 'Three adjacent hues, 30° apart. They share wavelengths so they feel naturally related — great for gradients, but light on built-in contrast.' },
  { title: 'Triadic', Icon: Triangle, angle: '120°', pair: ['#EF4444', '#22C55E', '#3B82F6'],
    desc: 'Three hues 120° apart, all pulling equal weight. Pick one dominant, one secondary, one accent — or everything fights. The most vibrant scheme.' },
  { title: 'Split-Complementary', Icon: ArrowLeftRight, angle: '150°/210°', pair: ['#8B5CF6', '#EAB308', '#F97316'],
    desc: "The complement's two neighbours rather than the complement itself. The same contrast range, but far easier to balance — a softer landing." },
  { title: 'Monochromatic', Icon: SlidersHorizontal, angle: '0° shift', pair: ['#C4B5FD', '#8B5CF6', '#3B0764'],
    desc: 'One hue across its full tonal range. Always cohesive, never clashing — the risk is monotony. Solve it with dramatic value steps.' },
...
const colors: ColorEntry[] = [
  ...
  { name: 'Orange', hex: '#F97316', hue: '30°',
    ...
    psychology: "Orange sits between the urgency of red and the cheer of yellow — it takes the best of both without their edge. It's the most social color: it stimulates conversation, signals approachability, and reads as energetic without being aggressive. It's also the color most associated with value and affordability.",
    inDesign: "Orange works where red feels too serious or alarming — the preferred CTA for brands that want action without anxiety. Food brands love it because it stimulates appetite while suggesting freshness. One underused quality: orange is extraordinarily legible against dark backgrounds at large sizes.",
    cultural: [
      { place: 'Netherlands', note: 'National color — the royal House of Orange-Nassau' },
      { place: 'Buddhism', note: "Sacred; monks' saffron robes symbolise renunciation" },
  ...
  { name: 'Yellow', hex: '#EAB308', hue: '60°',
    ...
    psychology: 'Yellow is the most visible color to the human eye in daylight — the brain processes it before any other hue. That same visibility becomes a liability indoors: yellow rooms register as stimulating to the point of anxiety. In moderate use, yellow sharpens attention and boosts analytical thinking.',
    inDesign: "Yellow signals 'pay attention here' better than almost any other color at the same size — ideal for badges, highlights, and emphasis. But it's terrible for body text on white (contrast drops below WCAG minimums). Against dark backgrounds it becomes one of the most legible colors available.",
    cultural: [
    ...
    fact: "Yellow is the most commonly cited 'least favourite color' in surveys — yet it's the color most associated with optimism and creativity in testing." },
  { name: 'Green', hex: '#22C55E', hue: '120°',
    ...
    psychology: 'Humans distinguish more shades of green than any other color — a legacy from scanning vegetation for food and safety. Green at 120° sits at the centre of the visible spectrum, making it the easiest wavelength for the eye to process. Green environments lower heart rate and reduce stress.',
    inDesign: "Green is the universal 'go' signal — confirmation dialogs, success states, 'in stock' badges. Healthcare and finance brands use it because it implies both health and growth. The challenge: yellow-green reads sickly; forest green reads premium. Hue matters more for green than any other color.",
    cultural: [
      { place: 'Islam', note: "Sacred — paradise is green, the Prophet's flag was green" },
      { place: 'Ireland', note: '"The Emerald Isle" — green is national identity' },
    ...
    fact: 'Night-vision goggles display green because human eyes are most sensitive to that wavelength — we resolve more detail in green than any other color.' },
  { name: 'Blue', hex: '#3B82F6', hue: '210°',
    ...
    inDesign: "Blue is the safest primary brand color — it rarely alienates and scales from serious to friendly via saturation and value. Saturated mid-blues feel modern and digital; navy feels authoritative; sky blue feels open. The one trap: blue disappears on dark backgrounds unless it's very bright.",
    cultural: [
      { place: 'Western', note: '"Feeling blue" yet "true blue" — contradictory, reflecting its range' },
  ...
  { name: 'Violet', hex: '#8B5CF6', hue: '263°',
    ...
    psychology: 'Violet sits at the extreme edge of human color perception, just before the spectrum crosses into ultraviolet. For most of history, purple dye required 12,000 shellfish per gram — worth more than gold. That scarcity is still embedded in our perception: purple reads as rare, elevated, and unusual.',
    inDesign: "Purple covers a wide creative range. Bright violet signals innovation — tech tools, AI products, game platforms. Deep purple signals luxury and heritage. Lavender is calming and increasingly used in wellness. The consistent quality: purple signals that something isn't mainstream.",
    cultural: [
  ...
  { name: 'Pink', hex: '#EC4899', hue: '330°',
    ...
    inDesign: "Hot pink holds its own against any color — it commands attention without the aggression of red. Soft pink is calming and increasingly used in non-gendered wellness and skincare. The sweet spot: mid-saturation pink — distinctive, warm, and approachable.",
    cultural: [
      { place: 'Japan', note: 'Cherry blossoms, transience, youth — deeply loved' },
  ...
  { name: 'Brown', hex: '#92400E', hue: '27°',
    ...
    psychology: "Brown is the color of shelter — wood, earth, stone, hide. Every home before industrialisation was built of it. That familiarity makes brown feel fundamentally safe and genuine. It's rarely anyone's declared favourite, yet it's universally recognised as trustworthy.",
    inDesign: "Brown is underused in digital design, which makes it distinctive. Rich chocolate browns signal premium quality; lighter tans feel organic and unpretentious — craft brands, farmers markets, sustainable goods. The challenge: brown can feel dated or dirty if mishandled.",
    cultural: [
    ...
    fact: "Brown doesn't exist on the visible spectrum — it's what the brain reads as dark, low-saturation orange. Change its brightness context and it becomes 'orange.'" },
  { name: 'Black', hex: '#111827', hue: '—',
    ...
    psychology: "Black is the absence of reflected light — it conveys absolute authority and finality. It makes adjacent colors appear more saturated, which is why luxury brands use so much of it. 'Black-tie,' 'black card,' 'black label' — the link to exclusivity is consistent across cultures.",
    inDesign: "Black is one of the most useful tools precisely because it's neutral — it never competes. Against black, every other color becomes more vivid, and typography is high-impact. The danger is heaviness: too much black and designs feel oppressive rather than sophisticated.",
    cultural: [
      { place: 'Western', note: 'Mourning, formality, luxury — the little black dress' },
      { place: 'Egypt', note: 'Rebirth and fertility — the black Nile soil' },
      { place: 'E. Asia', note: 'Wisdom, experience, and in some contexts prosperity' },
      { place: 'Fashion', note: 'Timelessness — the foundation for 200 years' },
    ],
  ...
  { name: 'White', hex: '#F8FAFC', hue: '—',
    ...
    psychology: "White reflects all wavelengths at once. It creates psychological space: white rooms feel larger. In design, white (negative space) is an active element, not empty filler — the absence of color gives the eye nowhere to land, and that pause registers as breath, clarity, or calm.",
    inDesign: "White is the foundation of minimalist design because it amplifies everything against it — a single bold red on white hits harder than on a busy background. The practical trap: pure white (#FFFFFF) on screens is harsh; most systems use near-whites (94–97% lightness).",
    cultural: [
      ...
      { place: 'India', note: 'Both peace and mourning — worn by widows' },
    ],
  ...
  { name: 'Gray', hex: '#6B7280', hue: '—',
    ...
    cultural: [
      ...
      { place: 'Tech', note: 'Precision and modernity — the default interface color' },
      { place: 'Fashion', note: '"Greige" became its own design movement' },
    ],
    brands: ['Apple', 'Mercedes-Benz', 'Porsche', 'Wikipedia', 'LinkedIn'],
    fact: 'Gray is the only color with two correct English spellings — "gray" (US) and "grey" (UK) — for exactly the same color.' },
];
        ...
        >
          <div className={cn('mx-auto w-full max-w-4xl px-5 sm:px-8', REVEAL, active === 0 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8')}>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-ink-2">
              Every color has physics, psychology, and history behind it. Scroll through each one — full screen, one hue at a time.
            </p>
            <button
              onClick={() => goTo(1)}
        ...
        >
          <div className={cn('mx-auto w-full max-w-6xl px-5 sm:px-8 py-12', REVEAL, active === 1 ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8')}>
            ...
            <p className="mt-3 max-w-xl text-sm text-ink-2 sm:text-base">
              These six relationships cover the vast majority of palette decisions you&apos;ll ever make.
            </p>
