...
- `src/components/` — `ui/` (primitives: Button, Card, CopyButton, EyeDropperButton, AnimateIn), `color-picker/` (the homepage picker: ImageUploader, ImageCanvas, ColorDisplay, ColorHistory, ClipboardPaste), `layout/` (Header, Footer, LegalDoc).
